...
- Shortest complete version — cut whole sentences and sections, not only words. Length is earned by purpose, never spent to look thorough.
- Say it once — no restating a point in new words, no recap of what was just said. One claim, one home.
- Cut waste, not substance — economy removes filler and redundancy, never precision or needed detail. The terse word is the exact word, not the simple one.
- Every section earns its place — remove a passage; if the artifact still does its job, it stays gone.
