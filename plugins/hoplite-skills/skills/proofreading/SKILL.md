---
name: proofreading
description: Sweep a prose artifact for the tells of machine writing — aphorisms, editorializing, hedging, enthusiasm — and fix what the sweep finds. Use on any corpus document before finishing it, or when asked to proofread a file.
---
