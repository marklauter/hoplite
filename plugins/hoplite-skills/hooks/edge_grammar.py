...
executable form of the locked spec at ``../references/expressing-edges.md``.
...
# not an edge target. See ../references/frontmatter.md.
...
def validate_target(target: str, *, inline: bool = False) -> str | None:
    ...
    return f"`{target}`: does not match the edge-target grammar (references/expressing-edges.md)"
