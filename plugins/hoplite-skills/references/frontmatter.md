...
- A wikilink is an edge to another document, and the key is the predicate, like `cites: ["[[shape]]"]`. For the wikilink grammar, see [[docs/specs/expressing-edges.md]].
...
An edge is a key whose value is a wikilink, and the key is the predicate — `supports`, `contradicts`, `supersedes`. The vocabulary is open, like tags: a new predicate is a doc change, not a schema migration. For the grammar and seed vocabulary, see [[docs/todos/predicates-are-an-open-vocabulary.md]].
...
- [[docs/specs/expressing-edges.md]] — the edge and wikilink grammar.
- [[docs/todos/predicates-are-an-open-vocabulary.md]] — the open-vocabulary predicate model.
- [[docs/specs/hoplite-architecture.md]] — the system this feeds.
