...
Write `docs/notes/<slug>.md` (slug = the title, kebab-case) to the frontmatter standard (`docs/hoplite/frontmatter.md`): `title`, `summary`, `tags: [note, <domain>]`, `created`, `status` (`evolving` while in flux, `locked` when settled).
