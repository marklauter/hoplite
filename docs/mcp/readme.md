...
- [tool-reference.md](../../plugins/hoplite/components/hoplite/tool-reference.md) — [Contract] The hoplite tool reference component, injected into the `taking-notes` and `journaling` skills so an authoring agent also learns the query surface.
...
5. [tool-reference.md](../../plugins/hoplite/components/hoplite/tool-reference.md) — the tool reference the authoring skills inject
