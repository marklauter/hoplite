...
The day-one shape in [[docs/specs/hoplite-architecture.md]] and [[docs/specs/hoplite-tool-api.md]] holds unchanged for everything below — these features extend the runtime without breaking the public surface.
