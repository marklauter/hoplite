...
- Multi-property predicates that today require self-joins on the dump (see [[docs/specs/hoplite-roadmap.md#columnar-projection-for-multi-property-predicates|columnar projection in roadmap]]) — an in-memory inverted index would serve them without leaving Python.
