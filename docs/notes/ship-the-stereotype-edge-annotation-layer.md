...
- [[docs/notes/hoplite-scales-to-the-cross-repo-knowledge-graph.md]] — the other parent todo from this session. Different code paths; concurrent or sequential, free order.
