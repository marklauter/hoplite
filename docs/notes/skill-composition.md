...
Implication: a single shared fragment under `plugins/skills/components/<name>/` is the source of truth for cross-cutting content. Editing it updates every consuming skill on the next reload; consumer SKILL.md files stay untouched.
