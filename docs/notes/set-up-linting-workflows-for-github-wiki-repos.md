# Set up linting workflows for GitHub wiki repos

Tags: todo,wiki,linting,github-actions,ci
The current writer/reviewer/triage loop is all editorial; there is no mechanical or structural pre-pass. CI in the wiki repo is the natural place to add it without putting npm on the dev box.
