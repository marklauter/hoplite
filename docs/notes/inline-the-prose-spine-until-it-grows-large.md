...
- [[docs/notes/refactor-taking-notes-to-ambient-instructions-model.md]] — taking-notes and journaling already migrated off the armory additive model to the template system; this note records why that direction is right, where it would reverse, and the gate principle behind it.
