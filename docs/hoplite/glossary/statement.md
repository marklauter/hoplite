...
Every statement is an assertion; [[confidence]] carries the trust — the author's and importer's word at 1.0, the engine's guess graded below. A statement about one document is a [[claim]]; a statement relating two resources is a [[relationship]]; the retired *fact* was the importer's claim. A document's body is not a statement: content stays text behind the search index, with the fingerprint as the importer's claim standing in. The retired *feature* — anything knowable about a document — was the statement before the model had the word.
