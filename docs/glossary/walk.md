...
- Walk is polymorphic over both graphs: the corpus graph and the vocabulary graph. Surveying the vocabulary — the retired *survey* — is match + walk over its namespaces.
