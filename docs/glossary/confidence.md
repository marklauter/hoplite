...
How likely a [[statement]] is to be real.
...
[[docs/todos/score-discovered-edges-by-rarity-weighted-feature-overlap]], and
for the content channel in
[[docs/todos/rank-related-edges-by-bm25-cosine-not-minhash-jaccard]].
