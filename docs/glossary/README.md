...
- [[docs/specs/hoplite]] — problem statement and scope.
- [[docs/specs/hoplite-feature-taxonomy]] — the feature taxonomy: the two origins (intrinsic, asserted) and the IDF-weighted Jaccard relatedness over the unified feature set.
- [[docs/specs/hoplite-affordances]] — the affordances concept: statements give rise to affordances; the write/read split; signifiers.
- [[docs/specs/hoplite-graph]] — the structure: resources, relationships, claims, vocabulary.
- [[docs/notes/one-walk-verb-spans-the-corpus-and-vocabulary-graphs]] — the two-graph and namespace-address model.
- [[docs/specs/README]] — the document map.
